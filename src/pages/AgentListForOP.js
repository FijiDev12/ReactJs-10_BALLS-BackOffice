...
function AgentListForOP() {
  ...
  const filteredAgent = admins.filter((item) =>
    ...
    sessionStorage.setItem("F10EditNumber", adminData.MobileNo)
    }
    ...
    const agentRegistration = () => {
        ...
        .then((res) => {
            ...
            if(res.data.data[0].responseMessage === "Affiliate account successfully created") {
                ...
                Swal.fire({
                    title: "MASTER AGENT ACCOUNT CREATED",
                    icon: "success",
                    confirmButtonText: "OK",
                })
                .then((result) => {
            ...
            } else if (res.data.data[0].responseMessage === "Invalid operator id"){
              Swal.fire({
    ...
    const updateStatus = (adminData) => {
        ...
        Swal.fire({
            title: `UPDATE THE STATUS OF ${adminData.FirstName} ${adminData.LastName}?`,
            text: "By Clicking 'OKAY' you agree to change the status of this Agent",
            icon: "warning",
            ...
            if (res.isConfirmed){
                ...
                .then((res) => {
                    if (res.data.data[0].responseCode === "0"){
                        ...
                        Swal.fire({
                            title: "AGENT ACCOUNT DOESNT EXISTS",
                            icon: "error",
                            confirmButtonText: "OKAY"
                        })
                        .then((res) => {
    ...
    const editAgentDetails = (e) => {
        ...
        .then((res) => {
          ...
          if (res.data.data[0].responseCode === "0") {
            ...
            sessionStorage.removeItem("F10EditNumber")
            Swal.fire({
              title: "AGENT's NAME ALREADY EXISTS",
              icon: "error",
              confirmButtonColor: "OKAY"
            })
            .then((res) => {
  ...
  return (
            ...
            >
                <Paper className="paperBG" elevation={3}>
                    ...
                    <Typography variant='h5'>
                        AGENT USERS LISTING <hr/>
                    </Typography>
                    <Grid container>
                        <Grid item xs={12} sm={12} md={5}>
                        </Grid>
                        <Grid sx={{ paddingTop: 1 }} item xs={12} sm={12} md={7}>
                            <Grid  container spacing={1}>
                                <Grid item xs={6}>
                                  {sessionStorage.getItem("F10_Data$0788") === "6"
                                  ?
                                  <>
                  ...
                  <Box sx={{ maxHeight: '62vh', overflow: "auto" }}>
                    <TableContainer component={Paper}>
                        <Table sx={{ minWidth: 700 }} aria-label="customized table">
                            <TableHead>
                            <TableRow>
                                <StyledTableCell>Agent Level</StyledTableCell>
                                <StyledTableCell align="center">Affiliate Code</StyledTableCell>
                                <StyledTableCell align="center">First Name</StyledTableCell>
                                <StyledTableCell align="center">Middle Name</StyledTableCell>
                                <StyledTableCell align="center">Last Name</StyledTableCell>
                                <StyledTableCell align="center">Contact Number</StyledTableCell>
                                <StyledTableCell align="center">Players Count</StyledTableCell>
                            ...
                            <TableBody>
                            {filteredAgent.map((admin) => (
                                <StyledTableRow key={admin.Idx}>
                                <StyledTableCell component="th" scope="row">
                                    {admin.AffiliateLevel === 2 ? "Master Agent" : "Sub Agent"}
                                </StyledTableCell>
                                <StyledTableCell align="center">{admin.EncryptCode}</StyledTableCell>
                                <StyledTableCell align="center">{admin.FirstName}</StyledTableCell>
                                <StyledTableCell align="center">{admin.MiddleName}</StyledTableCell>
                                <StyledTableCell align="center">{admin.LastName}</StyledTableCell>
                                <StyledTableCell align="center">{admin.MobileNo}</StyledTableCell>
                                <StyledTableCell align="center">{admin.PlayerCount}</StyledTableCell>
                                <StyledTableCell align="center" onClick={() => updateStatus(admin)} style={{ textAlign: 'center', fontWeight: 'bolder', color: admin.IsActive === 1 ? '#54B435' : '#FF1E1E', cursor: "pointer"}}>
                                {admin.IsActive === 1 ? 'Active' : admin.IsActive === 0 ? 'Inactive' : ''}
                                </StyledTableCell>
                    ...
                    <TableContainer component={Paper}>
                        <Table sx={{ minWidth: 700 }} aria-label="customized table">
                            ...
                            {filteredAgent.map((admin) => (
                                ...
                                <StyledTableCell align="center">{admin.MobileNo}</StyledTableCell>
                                <StyledTableCell align="center">{admin.PlayerCount}</StyledTableCell>
                                <StyledTableCell align="center" style={{ textAlign: 'center', fontWeight: 'bolder', color: admin.IsActive === 1 ? '#54B435' : '#FF1E1E', cursor: "pointer"}}>
                                {admin.IsActive === 1 ? 'Active' : admin.IsActive === 0 ? 'Inactive' : ''}
                                </StyledTableCell>
                                </StyledTableRow>
                            ))}
    ...
    <Dialog
      ...
      >
        ...
        <DialogActions>
          <Button autoFocus onClick={agentRegistration}>
            SUBMIT
          </Button>
    ...
    <Dialog
      ...
      >
        ...
        <DialogActions>
          <Button autoFocus onClick={editAgentDetails}>
            SUBMIT
          </Button>
    ...
    <Dialog
      ...
      >
        ...
        <DialogActions>
            <Button autoFocus onClick={editAgentPassword} disabled={!passwordsMatch}>
            SUBMIT
            </Button>
