...
import { Box, CssBaseline, Grid, Paper, TableContainer, Typography, Table, TableRow, Button, TableHead, TableBody, TextField, IconButton, TableFooter, TablePagination } from '@mui/material';
...
function GameHistoryForOP() {

    const navigate = useNavigate()
    const queryParameters = new URLSearchParams(window.location.search)
    const adminsession = queryParameters.get("d")
    const sessionUsing = decryptData(adminsession);
...
export default GameHistoryForOP